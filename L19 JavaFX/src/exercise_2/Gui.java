...
public class Gui extends Application {
    ...
    private void initContent(GridPane pane) {
        ...
        btnAddPerson.setOnAction(event -> {
            if (!txfName.getText().isEmpty() && !txtTitle.getText().isEmpty()) {
                addPerson();
            } else {
                ...
                if (txfName.getText().isEmpty() && txtTitle.getText().isEmpty()) {
                    alert.setContentText("You need to add a name and a title");
                } else if (txfName.getText().isEmpty()) {
                    alert.setContentText("You need to add a name");
                } else {
                    alert.setContentText("You need to add a title");
                }
                alert.show();
            }
        });
